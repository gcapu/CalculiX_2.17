...
void help( void )
{
  ...
  printf ("   'area' <set> \n");
  printf ("   'asgn' 'n'|'e'|'p'|'l'|'c'|'s'|'b'|'S'|'L'|'se'|'sh'|'alpha'|'beta'|'nadapt' <value>|'netgen'|'tetgen'|'thrds' <value>|['rbe' <value>|'mpc']|'max'|'maxr'|'maxc' [<col>]|'minc' [<col>]\n");
  ...
  printf ("   'maxr' <value> ['f'|'i'|'e'] ['l'|'u']\n");
  printf ("   'maxc' <value> ['f'|'i'|'e'] ['l'|'u']\n");
  ...
  printf ("   'minr' <value> ['f'|'i'|'e'] ['l'|'u']\n");
  printf ("   'minc' <value> ['f'|'i'|'e'] ['l'|'u']\n");
  ...
  printf ("   'test' ['o' <set>|'nodenr'] | ['d'|'v'|'n'|'e'|'p'|'l'|'c'|'s'|'b'|'S'|'L'|'se'|'sh' <name>]\n");
  ...
  printf ("   'valu' <name> [[<value>|'push' [<splitkey>]]|'pop' [nr]]|[['?'|'&'['*'|'/'|'+'|'-'|'abs'|'int'|'float'|'exp'|'max'|'min'|'pow'|'sqr'|'sin'|'cos'|'tan'|'asin'|'acos'|'atan'] [name|<const> name|<const>]]\n");
