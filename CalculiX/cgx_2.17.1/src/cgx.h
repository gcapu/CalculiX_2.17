...
#ifdef MTU
  #ifdef DEVEL
    #define     HELPFILE        {"/yaprod/struct/SLE12/app/cgx/prod/doc/cgx.html",\
                             "/yaprod/struct/SLE12/app/ccx/prod/doc/ccx.html"}
  #else
    #define     HELPFILE        {"/yaprod/cae/application/CalculiX/doc/cgx_2.17/cgx.html",\
                             "/yaprod/cae/application/CalculiX/doc/ccx_2.17/ccx.html"}
  #endif
  /* default tet mesher, 0:Netgen ng_vol, 1:tetgen */
  #define     TETMESHER  0
#elif defined AFLIB
  #define     HELPFILE        {"/usr/local/CalculiX/cgx_2.17.1/doc/cgx/cgx.html",\
...
/* writefbd.c */
int writefbd(char *setname, Summen *anz, SumGeo *anzGeo, Points *pnt, Lines *line, Lcmb *lcmb, Gsur *surf, Gbod *body, Nurbs *nurs, Sets *set, Shapes *shape, Values *value, char *format );
